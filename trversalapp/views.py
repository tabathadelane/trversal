...
class LocCreateView(CreateView):
    ...
    def get_success_url(self):
      return reverse_lazy('trversal:view-trip', args=(self.kwargs["pk"],))

    def form_valid(self, form):
        form_trip = Trip.objects.get(pk=self.kwargs["pk"])
        form.instance.trip = form_trip
        form.instance.order = form_trip.locs.count() + 1
...
class LocUpdateView(UpdateView):
    ...
    def get_success_url(self):
      return reverse_lazy('trversal:view-trip', args=(self.object.trip.pk,))
...
class LocDeleteView(DeleteView):
    ...
    def get_success_url(self, **kwargs):
        return reverse_lazy('trversal:view-trip', args=(self.object.trip.id,))
